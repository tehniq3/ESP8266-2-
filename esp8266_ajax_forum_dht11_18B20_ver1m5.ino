...
// version by niq_ro with DS18B20 & DHT11
...
const long COM_BAUD = 19200;                       //ESP UART baudrate
...
*/
  // time untill reset
       ...
       taim2 = (kil-taim)/1000; // seconds
       taim3 = taim2/60;
       taim2 = taim2 - 60*taim3;
       connection->send(String(taim3));
       if (taim2 < 10) connection->send(F(":0"));
       else connection->send(F(":"));
       connection->send(String(taim2));
